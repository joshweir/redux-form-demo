...
To remind myself how I set up this project:

```bash
cd && create-react-app joshweir.com
cd joshweir.com && yarn start
# verify running at http://localhost:3000, kill app
# add eslint
yarn add eslint --dev
./node_modules/.bin/eslint --init
#select "use a popular style guide" > "airbnb" > use react > JSON format for config
#update .eslintconfig and .eslintignore
