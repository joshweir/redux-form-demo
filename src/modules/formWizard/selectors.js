...
export const getNextDisabled = state =>
  !state.formWizard.currentPage || getCurrentPage(state) >= getTotalPages(state)
...
export const getIsFormLoading = state =>
  state.formWizard.loading || !state.formWizard.currentPage
export const getSessionId = state => state.formWizard.sessionId
export const getError = state => state.formWizard.error
